...
# output point data
pts_path_out = os.path.join(os.getcwd(), 'input', '02_input', 'mesh_point.csv')
...
# output element data
elm_path_out = os.path.join(os.getcwd(), 'input', '02_input', 'mesh_element.csv')
...
flx_path_out = os.path.join(os.getcwd(), 'input', '02_input', 'boundary_flux.csv')
...
# denote the left value as boundary config 0
# denote the right value as boundary config 1
val_path_out = os.path.join(os.getcwd(), 'input', '02_input', 'boundary_value.csv')
val_arr_out = np.zeros((2, 3))
val_arr_out[0, 0] = 0  # first element
val_arr_out[0, 1] = 0  # local ID of left point (p0)
val_arr_out[0, 2] = 0  # boundary config 0
val_arr_out[1, 0] = num_elm - 1  # last element
val_arr_out[1, 1] = 1  # local ID of right point (p1)
val_arr_out[1, 2] = 1  # boundary config 1
