...
# output point data
pts_path_out = os.path.join(os.getcwd(), 'input', '05_input', 'mesh_point.csv')
...
# output element data
elm_path_out = os.path.join(os.getcwd(), 'input', '05_input', 'mesh_element.csv')
...
val_path_out = os.path.join(os.getcwd(), 'input', '05_input', 'boundary_value_c1.csv')
...
### boundary conditions for c2

# create flux-type boundary condition
# denote the flux as boundary config 2
# left most point of domain = p0 of first element
flx_path_out = os.path.join(os.getcwd(), 'input', '05_input', 'boundary_flux_c2.csv')
flx_arr_out = np.zeros((1, 3))
flx_arr_out[0, 0] = 0  # first element
flx_arr_out[0, 1] = 0  # local ID of left point (p0)
flx_arr_out[0, 2] = 2  # boundary config 2
pd.DataFrame(flx_arr_out).to_csv(flx_path_out, header=['elm_gid', 'pts_lid_a', 'bc_cfg'], index=None)

# create value-type boundary condition
# denote the value as boundary config 3
# right most point of domain = p1 of last element
val_path_out = os.path.join(os.getcwd(), 'input', '05_input', 'boundary_value_c2.csv')
val_arr_out = np.zeros((1, 3))
val_arr_out[0, 0] = num_elm - 1  # last element
val_arr_out[0, 1] = 1  # local ID of right point (p1)
