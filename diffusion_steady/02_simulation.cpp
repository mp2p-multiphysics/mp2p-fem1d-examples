...
int main()
{
    ...
    // initialize mesh
    MeshLine2 mesh_dom1("input/02_input/mesh_point.csv", "input/02_input/mesh_element.csv");  // mesh for domain 1

    // initialize boundary conditions
    BoundaryLine2 boundary_dom1("input/02_input/boundary_flux.csv", "input/02_input/boundary_value.csv");
    boundary_dom1.set_boundarycondition(0, "dirichlet", {temp_a});  // left value is denoted as 0 in input files
    boundary_dom1.set_boundarycondition(1, "dirichlet", {temp_b});  // right value is denoted as 1 in input files
    ...
    // output results
    temp_dom1.output_csv("output/02_output/temp_dom1.csv");
