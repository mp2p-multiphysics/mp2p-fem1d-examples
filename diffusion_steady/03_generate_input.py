...
# output point data
pts_path_out = os.path.join(os.getcwd(), 'input', '03_input', 'mesh_point.csv')
...
# output element data
elm_path_out = os.path.join(os.getcwd(), 'input', '03_input', 'mesh_element.csv')
...
flx_path_out = os.path.join(os.getcwd(), 'input', '03_input', 'boundary_flux.csv')
...
val_path_out = os.path.join(os.getcwd(), 'input', '03_input', 'boundary_value.csv')
